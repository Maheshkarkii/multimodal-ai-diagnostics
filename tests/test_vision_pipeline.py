...
def test_trainer_synthetic_epoch_and_checkpoint():
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        cfg = ExperimentConfig(
            experiment_name="test_trainer_exp",
        ...
        assert (tmp_path / "ckpts" / "test_trainer_exp_best.pt").exists()
        assert (tmp_path / "ckpts" / "test_trainer_exp_latest.pt").exists()
...
def test_vision_predictor_synthetic_image():
    ...
    assert res["predicted_fault"] in classes
